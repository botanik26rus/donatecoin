...
static const unsigned int MAX_BLOCK_SIZE = 1000000; //Максимальный размер блока(в байтах шоле)
static const unsigned int MAX_BLOCK_SIZE_GEN = MAX_BLOCK_SIZE/2;
static const unsigned int MAX_BLOCK_SIGOPS = MAX_BLOCK_SIZE/50;
static const unsigned int MAX_ORPHAN_TRANSACTIONS = MAX_BLOCK_SIZE/100;
static const int64 MIN_TX_FEE = 10000000; //Минимальная коммиссия за транзакцию 0.1 монета
static const int64 MIN_RELAY_TX_FEE = MIN_TX_FEE;
static const int64 MAX_MONEY = 42007680 * COIN; // Максимальное количество монет 42 007 680 coins
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 5760 / 250; // 5760 blocks found a day. Priority cutoff is 1 DNC day / 250 bytes.
    }
